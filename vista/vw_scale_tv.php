...
class vw_scale_tv {
            ...
            <div class="m-l-n m-t-sm m-r-n">
                ...
                foreach ($lista_alarmas as $resultados):
                    ...
                    echo '	<div class="col-md-4">
							<a href="#CL-AI"><div class="ui-widget-content ui-state-hover ui-state-focus '.$background.' p-sm m-l-n m-r-n text-center">
								<div class="row">
    ...
    public static function lista_top_recurrentes($cantidad) {
        ...
        <div class="col-md-12">
            ...
            <div class="ui-widget-content white-bg p-lg" style="height: 593px">
